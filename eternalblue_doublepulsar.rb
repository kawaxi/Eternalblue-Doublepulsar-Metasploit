...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
	...
	register_options([
		...
		OptString.new('ETERNALBLUEPATH',[true,'Path directory of Eternalblue','/root/Eternalblue-Doublepulsar/deps/']),
		OptString.new('DOUBLEPULSARPATH',[true,'Path directory of Doublepulsar','/root/Eternalblue-Doublepulsar/deps/']),
